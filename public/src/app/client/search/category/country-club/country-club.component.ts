...
@Component({
  selector: "app-country-club",
  templateUrl: "./country-club.component.html",
  styleUrls: ["./country-club.component.css"],
...
export class CountryClubComponent implements OnInit {
  ...
  getVenues(): void {
    this._venueService.getSingleVenue("5a8139e600114b31f5f3ac63", venues => (this.venues = venues));
